...
-   Event Category 
    -   ILogger<T> 에서의 T를 의미함. 즉 어떤 카테고리(기본적으론 컨트롤러)에서 로그를 찍은건지 구분하는 것  
        ...
        [##_Image|kage@oUesc/btsGBZmUtKq/2eriCgPwKAj2GR1dTKwKN0/img.png|CDM|1.3|{"originWidth":589,"originHeight":100,"style":"alignCenter","filename":"blob"}_##]중요도: 카테고리   
        메시지 
    ...
    -   DI를 통해 컨트롤러 이름이 아닌 별도의 카테고리 명을 설정할 수도 있음  
        ...
        [##_Image|kage@bsrm3U/btsGC0STbFo/YqlLQ6N38uQ3828uNdeKo1/img.png|CDM|1.3|{"originWidth":604,"originHeight":73,"style":"alignCenter"}_##]
-   **Message**
    -   로깅 메시지
        -   두 가지 방식이 있음. 
...
[##_Image|kage@PW0UB/btsGFFUiEpd/u6TT8lSB3NxUhBjik5ZxW0/img.png|CDM|1.3|{"originWidth":416,"originHeight":512,"style":"alignCenter"}_##]

찾아보기 누르고 rollingfile 검색 ㄱㄱ

[##_Image|kage@bEnjjm/btsGGbFtsfW/av0R2MwqWUtX8ofLH6Jzt0/img.png|CDM|1.3|{"originWidth":796,"originHeight":610,"style":"alignCenter"}_##]
...
[##_Image|kage@dgrSZc/btsGDAfpVv6/rPtwdKlIlf2EuGVxFNSJ5k/img.png|CDM|1.3|{"originWidth":768,"originHeight":286,"style":"alignCenter"}_##][##_Image|kage@cMtKwX/btsGEWWy6S1/Fi2Lw5jCgcoVKgEUnioTCk/img.png|CDM|1.3|{"originWidth":1070,"originHeight":266,"style":"alignCenter"}_##]
...
-   Console인 경우 기본 메시지는 Critical 수준 이상부터 찍도록 했다.  
    [##_Image|kage@ca6aIG/btsGFkW9gcS/3mZtPU1PWBTFVQ9cxSbZJk/img.png|CDM|1.3|{"originWidth":1122,"originHeight":167,"style":"alignCenter"}_##]
    -   실행하니, 콘솔창에서 Information 수준의 로그들이 다 사라졌다!
-   그러나 파일에는 그대로 Information 수준부터 찍도록 했다.[##_Image|kage@kD1uP/btsGFAMgryb/sexAuUaKRyHVJiQlamd8c1/img.png|CDM|1.3|{"originWidth":1061,"originHeight":656,"style":"alignCenter"}_##]
...
[##_Image|kage@nFPme/btsGCWbWaoE/79YbSIEUIBwzj0DXOfTm10/img.png|CDM|1.3|{"originWidth":711,"originHeight":599,"style":"alignCenter"}_##]
...
[##_Image|kage@epMNJV/btsGCommjlH/mIzMtKAQhQi4KZd6u1kzM0/img.png|CDM|1.3|{"originWidth":946,"originHeight":565,"style":"alignCenter"}_##]
