...
-   여기에 요청과 관련된 모든 정보들이 들어가게 됨. (요청을 한 사용자에 대한 정보 포함)
    -   HttpContext.User : 현재 사용자(Principal) 확인  
        [##_Image|kage@cd3lQN/btsGCZNgBRg/74Qi8yfkte0kCz6rExdNW0/img.png|CDM|1.3|{"originWidth":655,"originHeight":131,"style":"alignCenter"}_##]
...
[##_Image|kage@bvBTvX/btsGC2QKmQS/R2E6kNCYkwZKTRTHamp7R1/img.png|CDM|1.3|{"originWidth":1018,"originHeight":674,"style":"alignCenter"}_##]
...
-   DB에 접속하는 EF Core 부분  
    [##_Image|kage@HiaTb/btsGDH6C0pu/pH3EVYA4ss8ISJ7Roz91GK/img.png|CDM|1.3|{"originWidth":257,"originHeight":57,"style":"alignCenter"}_##]
-   어떤 DB를 사용할지 지정되어 있음[##_Image|kage@bZMDzB/btsGE3H76K3/hVbkVqUcCFbYZh9C4gWEK0/img.png|CDM|1.3|{"originWidth":1386,"originHeight":119,"style":"alignCenter"}_##]
-   실행해보면, 우측 상단에 Register와 Login이 추가되어있다.[##_Image|kage@rAnna/btsGCXaP622/AxsO7kL0KgSegRrkp0wk0k/img.png|CDM|1.3|{"originWidth":1919,"originHeight":1030,"style":"alignCenter"}_##]  
...
[##_Image|kage@AQlot/btsGCbOdA9x/hPmFxW48lMpBswepayNMH1/img.png|CDM|1.3|{"originWidth":249,"originHeight":203,"style":"alignCenter"}_##]
...
[##_Image|kage@SKiVl/btsGCZGtSwv/aXQBsTqvskeO8CCgwVPNt0/img.png|CDM|1.3|{"originWidth":955,"originHeight":656,"style":"alignCenter"}_##]

-   Identity를 볼 수 있도록 하겠다는 의미

[##_Image|kage@B4gGg/btsGDAfpVvu/QvgeBKJcFAHz1GwKawDiQ0/img.png|CDM|1.3|{"originWidth":804,"originHeight":613,"style":"alignCenter"}_##]

-   Identity와 관련하여, 재정의할 파일을 선택한다. (보이게 해서 수정할 수 있도록 할 파일)

이렇게 하면 선택한 파일이 이제 프로젝트에서 볼 수 있도록 설정된다.

[##_Image|kage@IwDna/btsGGcEok0U/nz6k4n9JMSWhdsisvvkOvk/img.png|CDM|1.3|{"originWidth":263,"originHeight":191,"style":"alignCenter"}_##]
...
[##_Image|kage@wCuM3/btsGFhsD6Ou/emsS9z9LzKzJvAHOZznaH0/img.png|CDM|1.3|{"originWidth":352,"originHeight":226,"style":"alignCenter"}_##]
...
[##_Image|kage@bEavdg/btsGCumpCV6/KM9ri0JQuXQCmwCKgAM5K1/img.png|CDM|1.3|{"originWidth":296,"originHeight":55,"style":"alignCenter","caption":"Register.cshtml.cs"}_##]

[##_Image|kage@ccYl3l/btsGBXbxNCh/icfpoPrrvdBvsoqLe7f9sk/img.png|CDM|1.3|{"originWidth":1054,"originHeight":402,"style":"alignCenter","caption":"Register.cshtml"}_##]

실행해보면, 실제로 웹에서 입력한 내용과 바인딩됨을 확인할 수 있다.

[##_Image|kage@zpeth/btsGCpr2RV3/KzTiZHKnTZHscF9oe5S1K0/img.png|CDM|1.3|{"originWidth":674,"originHeight":89,"style":"alignCenter"}_##]
...
[##_Image|kage@beNxWB/btsGEkKa66J/Ow7tInQmjzcDA2LcMLVQF1/img.png|CDM|1.3|{"originWidth":316,"originHeight":536,"style":"alignCenter"}_##]

-   \_\_EFMigrationHistory
    -   EF Core의 Migration 버전을 관리한다.
-   **AspNetUsers**[##_Image|kage@bUkPoM/btsGCWwdZmQ/iqQTdun9RRQVRKfOlsp1qK/img.png|CDM|1.3|{"originWidth":922,"originHeight":654,"style":"alignCenter"}_##]
    -   핵심 user 정보를 관리한다.
-   **AspNetUserClaims**
    -   추가 정보를 관리
